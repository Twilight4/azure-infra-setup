...
- =versions.tf= locking terraform + provider ranges.
...
5. *Modules & standard structure* — keep reusable modules (network, security, compute, db) to make environments (dev/staging/prod) easy to manage and test. Follow Terraform module structure guidance. 
...
* Roadmap WIP
- [ ] Add CI pipeline
- [ ] optional modules for AKS
- [ ] Application Gateway (WAF)
- [ ] Azure Monitor
- [ ] =modules/appgw/= for Application Gateway + WAF module.
- [ ] =modules/aks/= if you prefer containers (AKS + managed identities).
