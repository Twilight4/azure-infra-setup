...
This repo builds an App Service (Free F1), and an Azure SQL Basic DB (250 MB) for learning. It intentionally avoids paid services (no VMSS, no Azure Firewall, no Private Endpoints).
